        ...
        module Movement
          ...
          def plan_entries(movers, enemies, claimed)
            ...
            ranked.each do |combatant|
              ...
              entries_by_id[combatant[:entity_id]] = Decisions::Movement.build_entry(combatant, enemy, side, :direct)
            end
            ...
            ranked.each do |combatant|
              ...
              side = choice[:contact_slot]
              claimed[enemy[:entity_id]][side] = combatant[:entity_id]
              entries_by_id[combatant[:entity_id]] = Decisions::Movement.build_entry(combatant, enemy, side, choice[:approach_mode])
            end
