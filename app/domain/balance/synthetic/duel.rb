    ...
    module Duel
      ...
      def run!(catalog:, config:, rng:)
        ...
        iterations.times do
          ...
          left, right = build_players(catalog, config, contact: contact)
          result = Sim::Battle::Simulator.call(left, right, catalog, rng: battle_rng, terrain: [])
      ...
      def build_players(catalog, config, contact:)
        ...
        deploy!(left_entity, right_entity, contact: contact)
      ...
      def deploy!(left_entity, right_entity, contact:)
      ...
      def contact_position(contact, left_x, left_y, left_dims, right_dims)
        case contact
        when "flank"
          [
