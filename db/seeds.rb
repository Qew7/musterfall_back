...
templates = [
  ...
  { template_key: "skeleton_block", kind: "unit", faction_slug: "undead", name: "Скелетный блок", cost: 6, models: 18, model_health: 1, width: 5, armor_type: "light", weapon_type: "slash", melee: 3, ranged: 0, spell: 0, initiative: 3, abilities: [ "undead", "steadfast" ], skill: 2, mounted: false, attacks: 1 },
  { template_key: "grave_guard", kind: "unit", faction_slug: "undead", name: "Стража могил", cost: 10, models: 10, model_health: 1, width: 5, armor_type: "heavy", weapon_type: "slash", melee: 5, ranged: 0, spell: 0, initiative: 3, abilities: [ "undead", "armorPiercing" ], skill: 4, mounted: false, attacks: 1 },
  ...
  { template_key: "bone_dragon", kind: "unit", faction_slug: "undead", name: "Костяной дракон", cost: 15, models: 1, model_health: 8, width: 2, armor_type: "light", weapon_type: "breath", melee: 3, ranged: 4, spell: 0, initiative: 4, abilities: [ "monster", "flying", "fear", "undead", "ranged" ], skill: 5, mounted: false, attacks: 3 },
  ...
  { template_key: "chaos_spawn", kind: "unit", faction_slug: "chaos", name: "Отродье Хаоса", cost: 12, models: 4, model_health: 3, width: 2, armor_type: "magic", weapon_type: "blunt", melee: 5, ranged: 0, spell: 0, initiative: 3, abilities: [ "monster", "fear", "regen" ], skill: 4, mounted: false, attacks: 2 },
  ...
  { template_key: "necromancer", kind: "hero", faction_slug: "undead", name: "Некромант", cost: 14, models: 1, model_health: 2, width: 1, armor_type: "magic", weapon_type: "magic", melee: 1, ranged: 5, spell: 5, initiative: 5, abilities: [ "wizard" ], skill: 5, mounted: false, attacks: 2 },
  { template_key: "wight_king", kind: "hero", faction_slug: "undead", name: "Король-лич", cost: 12, models: 1, model_health: 3, width: 1, armor_type: "heavy", weapon_type: "puncture", melee: 4, ranged: 0, spell: 0, initiative: 5, abilities: [ "leader", "undead" ], skill: 5, mounted: false, attacks: 2 },
  { template_key: "waystalker", kind: "hero", faction_slug: "wildwood", name: "Вэйстокер", cost: 14, models: 1, model_health: 2, width: 1, armor_type: "light", weapon_type: "ranged", melee: 2, ranged: 5, spell: 0, initiative: 5, abilities: [ "leader", "ranged" ], skill: 5, mounted: false, attacks: 2 },
  { template_key: "spellweaver", kind: "hero", faction_slug: "wildwood", name: "Спеллвивер", cost: 14, models: 1, model_health: 2, width: 1, armor_type: "magic", weapon_type: "magic", melee: 2, ranged: 5, spell: 5, initiative: 5, abilities: [ "wizard" ], skill: 5, mounted: false, attacks: 2 },
